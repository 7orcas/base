...
CREATE TABLE base.userAccCache (
    id BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 10000),
    userAccId BIGINT NOT NULL,
    cacheKey VARCHAR(40) NOT NULL,
    details TEXT,
    PRIMARY KEY (id),
    UNIQUE (userAccId, cacheKey),
    FOREIGN KEY (userAccId) REFERENCES base.useracc(id)
);
COMMENT ON TABLE base.userAccCache IS 'A persisted users cache';
COMMENT ON COLUMN base.userAccCache.cacheKey IS 'Hard coded key';
