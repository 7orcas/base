...
CREATE TABLE cntrl.loginoption (
	...
	isforgot BOOLEAN NOT NULL DEFAULT FALSE,
	isselfregistration BOOLEAN NOT NULL DEFAULT FALSE,
	ismasquerade BOOLEAN NOT NULL DEFAULT FALSE
);
...
COMMENT ON COLUMN cntrl.loginoption.ismasquerade IS 'true == show user name to login as';
COMMENT ON COLUMN cntrl.loginoption.ismfa IS 'show mfa code input by default';
